    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      >
        ...
        <h2 className="text-lg md:text-2xl lg:text-3xl font-thin mb-8 text-white flex justify-center items-center">
          <span className="flex items-center">Scan. Match.</span>&nbsp;
          <span className="text-gradient font-bold flex items-center">
            Act.
          </span>
        </h2>
        <div className="button-container">
          <Link to={`${homeDirectory}/register`} className="navigation-button">
            <p className="text-base md:text-2xl lg:text-3xl button-text">
              Join the party!
            </p>
          </Link>
        </div>
